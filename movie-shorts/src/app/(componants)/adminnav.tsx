...
export default function HeaderMenuColored({ links = [] }: HeaderSearchProps) {
  ...
  // Add "Add new movie" and "Explore" menu items
  const additionalItems = (
    <>
      <a href="/add-movie" className={classes.link}>
       Home page
      </a>
...
// 'use client'
// import { createStyles, Header, Menu, Group, Center, Burger, Container, rem,Select, TextInput } from '@mantine/core';
// import { useDisclosure } from '@mantine/hooks';
// import { IconChevronDown } from '@tabler/icons-react';
// import { MantineLogo } from '@mantine/ds';
// import { UserButton } from "@clerk/nextjs";
